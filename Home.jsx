...
const Home = () => {
  ...
  return (
    ...
    overflow-hidden'>
        ...
        className='fiexd top-0 left-0 right-0 z-50 backdrop-blur-xl bg-black/40
        border-b border-white/10'>

            <div className='max-w-7xl mx-auto px-6 py-4 flex justify-between items-center'>
                <div className='text-lg font-semibold'>
                    {/* iska andar ham logo likha ga matlab left side vala kam  */}
                    GenWeb.Ai
                </div>
                <div className='flex items-center gap-5'>
                    {/*iska andar right side vala kam honga  */}
                    <div className='hidden md:inline text-sm text-zinc-400 hover:text-white cursor-pointer'>
                        {/* first div ma ham pricing check kranga click krka */}
                        Pricing
                    </div>
    ...
    >
            ...
            >
                Describe Your Ideas and let AI generate a modern,
                responsive,production-ready website.
            </motion.p>

           
                <button className='mt-10 px-10 py-4 rounded-xl bg-white text-black
